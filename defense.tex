...
\begin{frame}{Building the TSI\NoCaseChange{s}}
\begin{enumerate}
  \item[2.] Assemble composite VIs into TSIs
  \begin{itemize}
...
\begin{frame}{Extract crop signatures}
\begin{enumerate}
...
\subsection{Eliminating Kansas Mixels}
