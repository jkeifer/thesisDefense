...
\column{0.55\linewidth}
  \begin{figure}
    \raggedleft
    \resizebox{\textwidth}{!}{\input{plots/firstsoyKS.pgf}}
...
\begin{figure}
  \centering
  \resizebox{0.65\textwidth}{!}{\input{plots/cropsigsAR.pgf}}
...
\begin{figure}
  \centering
  \resizebox{0.65\textwidth}{!}{\input{plots/poroto_pasture_sigsAR.pgf}}
\end{figure}
\end{frame}
...
\begin{figure}
  \centering
  \resizebox{0.65\textwidth}{!}{\input{plots/othersigsAR.pgf}}
\end{figure}
\end{frame}
